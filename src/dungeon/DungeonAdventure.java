...
//        spawnRooms(count);
        ...
        for (int i = 0; i < dg.finalDungeon.length; i++) {
            for (int j = 0; j < dg.finalDungeon[0].length; j++) {
                if (j % 2 == 1 && i % 2 == 1 && dg.finalDungeon[i][j].myRoomContents.equals("S")) {
                    if (i > 1) {
                        if (dg.finalDungeon[i][j].myNeighbors[0] == dg.finalDungeon[i - 2][j]) {
                            ui.spawnItem(hv, (((int) Math.ceil((double)j / 2) * 26) + ((j / 2) * 51)) + 14, (((int) Math.ceil((double)(i - 1)/2) * 20) + (((i - 1) / 2) * 51)) - 6, count++);
                        }
                    }
                    if (j > 1) {
                        if (dg.finalDungeon[i][j].myNeighbors[3] == dg.finalDungeon[i][j - 2]) {
    ...
    public int spawnRooms(int c) {
        ...
        for (int i = 0; i < dg.finalDungeon.length; i++) {
            for (int j = 0; j < dg.finalDungeon[0].length; j++) {
                if (j % 2 == 1 && i % 2 == 1 && dg.finalDungeon[i][j].myRoomContents.equals("S")) {
//                    if (dg.finalDungeon[i][j].myNeighbors[0] == null) {
//                        roomExits.append(0);
//                    } else {
//                        roomExits.append(1);
//                    }
//                    if (dg.finalDungeon[i][j].myNeighbors[1] == null) {
//                        roomExits.append(0);
//                    } else {
//                        roomExits.append(1);
//                    }
//                    if (dg.finalDungeon[i][j].myNeighbors[2] == null) {
//                        roomExits.append(0);
//                    } else {
//                        roomExits.append(1);
//                    }
//                    if (dg.finalDungeon[i][j].myNeighbors[3] == null) {
//                        roomExits.append(0);
//                    } else {
//                        roomExits.append(1);
//                    }
                    for (int k = 0; k < 4; k++) {
                    	if (dg.finalDungeon[i][j].myNeighbors[k] == null) {
                    		roomExits.append(0);
                    	} else {
                    		roomExits.append(1);
                    	}
